...
List<Sight> mockWantToVisitSights =
    sightMocks.where((sight) => sight.wantToVisit != null && sight.wantToVisit!).toList();
List<Sight> mockVisitedSights =
    sightMocks.where((sight) => sight.visited != null && sight.visited!).toList();
