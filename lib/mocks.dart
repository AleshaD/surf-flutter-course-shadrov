...
List<Sight> sightMocks = [
  Sight(
    ...
    lat: 44.435251,
    lon: 33.780875,
    photoUrls: ['https://media-cdn.tripadvisor.com/media/photo-s/0b/ca/a4/ea/caption.jpg'],
  ...
  Sight(
    ...
    lat: 1.0,
    lon: 2.2,
    photoUrls: ['https://media-cdn.tripadvisor.com/media/photo-s/0f/39/96/8d/caption.jpg'],
    details:
